...
def save_model(net, args, config, model_name, epoch, fold):
    ...
    save_to_cloud_loc(state_dict, 'learning-dynamics-models', f"{args.dataset.lower()}/conf_learning_fold_{fold}_{model_name}_noisy_idx_{args.random_seed}_epoch_{epoch}_noise_{args.label_noise}.ckpt")
